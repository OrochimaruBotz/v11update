...
let handler = async (m, { conn, usedPrefix, owner }) => { 
    try { 
        ...
        if (global.db.data.users[m.sender].health > 79) {
            ...
            let str = `
Nyawa mu berkurang -${health * 1} karena Kamu telah berpetualang sampai ${pickRandom(['Jepang', 'Cina', 'Jogja', 'Hitam', 'Hotel Manusia Cina', 'Arab', 'Ke Masa lalu', 'Bogor', 'Akhir hayat', 'Anime Portal', 'Ujung dunia', 'Rumah Owner', 'Meninggal', 'Markas Psatir', 'Markas Nazi', 'Rumah Makan Pak Nigga', '...'])} dan mendapatkan
*exp:* ${exp} 
*uang:* ${uang}
*tiketcoin:* 1
